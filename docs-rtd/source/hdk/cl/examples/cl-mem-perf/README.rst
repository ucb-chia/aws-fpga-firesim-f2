...
- `Software <#software>`__
  ...
  - `Software Tests <#software-tests>`__
  - `Compile and run instructions <#compile-and-run-instructions>`__
  - `Cosim Compile and run
    instructions <#cosim-compile-and-run-instructions>`__
...
PF/BARs as stated in the table below. Please See `PCIe Memory
Map <../../../docs/AWS-Fpga-Pcie-Memory-Map.html>`__ for more details on
bar sizes, and `AWS Shell Interface
Specification <../../../docs/AWS-Shell-Interface-Specification.html>`__
for available interfaces between the Shell and the CL.
...
- HBM AXI3 interface is clocked by the 450MHz clock generated from the
  `AWS_CLK_GEN <https://github.com/aws/aws-fpga/tree/f2/hdk/common/lib/aws_clk_gen.sv>`__ block. The
  ...
  spec <./../../../docs/AWS-CLK-GEN-spec.html>`__ for details on this
...
clk_main_a0 and HBM’s AXI3 clock, and AXI4-to-AXI3 protocol converter to
ultimately connect to HBM AXI Channel#0
...
Space <#cl-hbm-axi4-register-address-space>`__ for details on register
address space and HBM memory address space.
...
2. The `AWS_CLK_GEN <https://github.com/aws/aws-fpga/tree/f2/hdk/common/lib/aws_clk_gen.sv>`__ module
   ...
   `AWS_CLK_GEN specification <./../../../docs/AWS-CLK-GEN-spec.html>`__
   for details on this block. The `Clock Recipes User
   Guide <./../../../docs/Clock-Recipes-User-Guide.html>`__ describes
   various clock recipes available for F2 developers and options on
   configuring clocks dynamically. The user guide also describes porting
   of CL designs based on F1 clock recipes into F2.
...
.. list-table::
   ...
   * - HBM Performance Kernels
     - 0x0400
     - 0x04FF
     - configure CL_HBM_PERF_KERNEL block.
   * - AXI4 Transaction Generator
     - 0x0500
     - 0x05FF
     - CL_AXI_MSTR Block
...
.. list-table::
   ...
   * - 
     ...
     - RO
     - 0x0
     - 2'b01 : HBM Stack#0 Initialized   2'b10 : HBM Stack#1 Initialized  2'b11 : HBM Stack#0 and Stack#1 are Initialized. HBM is now ready to use.
   * - 
     - 
     - 0
     - RW
   ...
   * - 0x40C
     ...
     - RW
     - 0x0
     - Select the Channel number to measure write and read latencies. This field is 0-based. Max Value = 31.
   * - 0x410
     - AXLEN_REG
     - 31:0
     - RW
...
.. |Diagram| image:: ../../../../_static/cl_mem_perf_images/cl_mem_perf.png
.. |image1| image:: ../../../../_static/cl_mem_perf_images/cl_hbm_kernel.png
